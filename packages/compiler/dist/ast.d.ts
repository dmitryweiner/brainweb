...
export type Declaration = SensorNode | EncoderNode | RegionNode | CircuitNode | ModulatorNode | EffectorNode | RuntimeNode;
...
export type PopulationNode = StatePopNode | SpikingPopNode | RecurrentPopNode | RatePopNode | WtaPopNode;
...
export declare function timeToMs(tv: TimeValue): number;
