// Generated by BrainWeb Compiler — GuessGame
// Do not edit by hand.
...
function createApp(fx, opts) {
  ...
  // Sensor wiring
  const sensorConfigs = [{"name":"UI","eventTypes":["Click"]}];
  let cleanupSensors = null;

  // Encoder
  const encoder = new BwEncoder({
    dim: 16,
    featureOps: [{"kind":"onehot","field":"EventType"},{"kind":"hash","field":"TargetCssPath","buckets":8}],
    eventTypeList: ["Click"],
  });
  ...
  // Effect table
  const effectTable = {};
  effectTable["React"] = function(ctx) { return fx.evaluate(ctx); };
  effectTable["Think"] = function(ctx) { return fx.evaluate(ctx); };

  // Guards
  const guards = new BwGuardChain([{"kind":"max_effects_per_sec","limit":10}]);
